namespace TechCos_LRG
{
    partial class JLGLoan
    {
        ...
        private void InitializeComponent()
        {
            ...
            visitReportBtn = new MaterialSkin.Controls.MaterialButton();
            preSanctionSurveyBtn = new MaterialSkin.Controls.MaterialButton();
            dueDiligenceReportBtn = new MaterialSkin.Controls.MaterialButton();
            ...
            // topPanel
            // 
            topPanel.Controls.Add(visitReportBtn);
            topPanel.Controls.Add(preSanctionSurveyBtn);
            topPanel.Controls.Add(dueDiligenceReportBtn);
            ...
            // visitReportBtn
            // 
            visitReportBtn.AutoSizeMode = AutoSizeMode.GrowAndShrink;
            visitReportBtn.Density = MaterialSkin.Controls.MaterialButton.MaterialButtonDensity.Default;
            visitReportBtn.Depth = 0;
            visitReportBtn.HighEmphasis = true;
            visitReportBtn.Icon = null;
            visitReportBtn.Location = new Point(944, 26);
            visitReportBtn.Margin = new Padding(4, 6, 4, 6);
            visitReportBtn.MouseState = MaterialSkin.MouseState.HOVER;
            visitReportBtn.Name = "visitReportBtn";
            visitReportBtn.NoAccentTextColor = Color.Empty;
            visitReportBtn.Size = new Size(116, 36);
            visitReportBtn.TabIndex = 25;
            visitReportBtn.Text = "Visit Report";
            visitReportBtn.Type = MaterialSkin.Controls.MaterialButton.MaterialButtonType.Contained;
            visitReportBtn.UseAccentColor = false;
            visitReportBtn.UseVisualStyleBackColor = true;
            visitReportBtn.Click += visitReportBtn_Click;
            // 
            // preSanctionSurveyBtn
            // 
            preSanctionSurveyBtn.AutoSizeMode = AutoSizeMode.GrowAndShrink;
            preSanctionSurveyBtn.Density = MaterialSkin.Controls.MaterialButton.MaterialButtonDensity.Default;
            preSanctionSurveyBtn.Depth = 0;
            preSanctionSurveyBtn.HighEmphasis = true;
            preSanctionSurveyBtn.Icon = null;
            preSanctionSurveyBtn.Location = new Point(532, 26);
            preSanctionSurveyBtn.Margin = new Padding(4, 6, 4, 6);
            preSanctionSurveyBtn.MouseState = MaterialSkin.MouseState.HOVER;
            preSanctionSurveyBtn.Name = "preSanctionSurveyBtn";
            preSanctionSurveyBtn.NoAccentTextColor = Color.Empty;
            preSanctionSurveyBtn.Size = new Size(183, 36);
            preSanctionSurveyBtn.TabIndex = 23;
            preSanctionSurveyBtn.Text = "Pre-Sanction Survey";
            preSanctionSurveyBtn.Type = MaterialSkin.Controls.MaterialButton.MaterialButtonType.Contained;
            preSanctionSurveyBtn.UseAccentColor = false;
            preSanctionSurveyBtn.UseVisualStyleBackColor = true;
            preSanctionSurveyBtn.Click += preSanctionSurveyBtn_Click;
            // 
            // dueDiligenceReportBtn
            // 
            dueDiligenceReportBtn.AutoSizeMode = AutoSizeMode.GrowAndShrink;
            dueDiligenceReportBtn.Density = MaterialSkin.Controls.MaterialButton.MaterialButtonDensity.Default;
            dueDiligenceReportBtn.Depth = 0;
            dueDiligenceReportBtn.HighEmphasis = true;
            dueDiligenceReportBtn.Icon = null;
            dueDiligenceReportBtn.Location = new Point(741, 26);
            dueDiligenceReportBtn.Margin = new Padding(4, 6, 4, 6);
            dueDiligenceReportBtn.MouseState = MaterialSkin.MouseState.HOVER;
            dueDiligenceReportBtn.Name = "dueDiligenceReportBtn";
            dueDiligenceReportBtn.NoAccentTextColor = Color.Empty;
            dueDiligenceReportBtn.Size = new Size(185, 36);
            dueDiligenceReportBtn.TabIndex = 24;
            dueDiligenceReportBtn.Text = "Due Diligence Report";
            dueDiligenceReportBtn.Type = MaterialSkin.Controls.MaterialButton.MaterialButtonType.Contained;
            dueDiligenceReportBtn.UseAccentColor = false;
            dueDiligenceReportBtn.UseVisualStyleBackColor = true;
            dueDiligenceReportBtn.Click += dueDiligenceReportBtn_Click;
            // 
            // amountDetailsBtn
            // 
            ...
            amountDetailsBtn.Location = new Point(354, 26);
            ...
            memberDetailsBtn.Location = new Point(180, 26);
            ...
            borrowerBtn.Location = new Point(35, 26);
            ...
            borrowerBtn.Size = new Size(109, 36);
        ...
        private MaterialSkin.Controls.MaterialButton visitReportBtn;
        private MaterialSkin.Controls.MaterialButton preSanctionSurveyBtn;
        private MaterialSkin.Controls.MaterialButton dueDiligenceReportBtn;
    }
}